...
export function PigeonForm() {
  ...
  const inputClass =
    "w-full px-2 xl:px-2.5 2xl:px-3 py-2 xl:py-2.5 2xl:py-2.5 bg-bg-input border border-border rounded-md text-sm xl:text-base 2xl:text-lg text-text-primary placeholder:text-text-disabled focus:border-accent focus:ring-2 focus:ring-accent/20 focus:outline-none";
  ...
  return (
    <div className="card-redesign p-4 xl:p-5 2xl:p-6">
      <p className="text-xs xl:text-xs 2xl:text-sm uppercase tracking-widest text-text-tertiary font-medium mb-3 xl:mb-3.5 2xl:mb-4">
        Podaci goluba
      </p>
